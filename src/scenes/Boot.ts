...
export class Boot extends Scene
{
    ...
    preload ()
    {
      ...
      this.load.audio('audioBackground', ['assets/sounds/music.ogg'])
      this.load.audio('audioJump', ['assets/sounds/jump.ogg'])
      this.load.audio('audioGetCoin', ['assets/sounds/getcoin.ogg'])
